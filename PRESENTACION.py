...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Ejemplos de uso:
  python PRESENTACION.py                           # Ejecutar con valores automáticos
  python PRESENTACION.py --periodo P2              # Período específico
  python PRESENTACION.py --año 2025                # Año específico
  python PRESENTACION.py --seccion vivero           # Sección específica
  python PRESENTACION.py -S maf -P P2 -A 2025      # Todos los filtros
  python PRESENTACION.py -S deco_interior -P P1    # Período y sección
        '''
    )
    ...
    if ALERTAS_DISPONIBLES:
        try:
            ...
            alert_service = crear_integrador("PRESENTACION")
            if alert_service:
    ...
    try:
        ...
        main()
        logger.info("Proceso de generación de presentaciones completado exitosamente.")
    except Exception as e:
        logger.critical(f"Error crítico en el script PRESENTACION: {e}", exc_info=True)
        if alert_service:
        ...
        if alert_service:
            try:
                alert_service.enviar_resumen_alertas("PRESENTACION")
            except Exception as e:
